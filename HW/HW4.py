...
- When a FILTER NOTE does give a total, state that number in your answer. It is the one
count you can report, and the student needs it to know how much the sample leaves out.
