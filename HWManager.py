...
hw3_page = st.Page("HW/HW3.py", title="HW3", icon=":material/description:", default=True)  #Default page

pg = st.navigation([hw3_page, hw2_page, hw1_page])  #HW3 listed first so it appears at the top of the sidebar
